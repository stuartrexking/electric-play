  ...
  (let [state    (e/watch !state)
    ...
    (dom/div (dom/props {:style {:display             :grid
      ...
      (let [!needle (atom ""), needle (e/watch !needle)]
        (ui/input needle (e/fn [v] (reset! !needle v))
      ...
      (let [stage (:stage state)]
        ...
        (ui/input (:name stage) (e/fn [v] (set-name! v))
          (dom/props {:style {:grid-area "f"}}))
        (dom/span (dom/props {:style {:grid-area "g"}}) (dom/text "Surname:"))
        (ui/input (:surname stage) (e/fn [v] (set-surname! v))
      ...
      (dom/div (dom/props
        ...
        (ui/button (e/fn [] (create!)) (dom/text "Create"))
        (ui/button (e/fn [] (update!)) (dom/text "Update")
          (dom/props {:disabled (not selected)}))
        (ui/button (e/fn [] (delete!)) (dom/text "Delete")
          (dom/props {:disabled (not selected)}))))))